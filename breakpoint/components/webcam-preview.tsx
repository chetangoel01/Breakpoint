...
export function WebcamPreview({
  ...
  const [lastPredictionTime, setLastPredictionTime] = useState<Date | null>(
    null,
  );
  ...
  return (
    <div className="flex flex-col items-center space-y-2 p-2">
      <div className="relative">
        ...
        {isEnabled && (
          <div
            className={`absolute top-2 left-2 px-2 py-1 rounded-full text-xs font-medium flex items-center space-x-1 transition-all duration-300 ${
