...
export function SettingsModal({
  ...
  const getSensitivityDescription = (level: string) => {
    switch (level) {
      case "low":
        return "Less sensitive - requires more obvious signs of fatigue";
      case "medium":
        return "Balanced - detects moderate signs of fatigue";
      case "high":
        return "Highly sensitive - detects early signs of fatigue";
      default:
        return "";
    }
  };
      ...
      <div className="relative w-80 backdrop-blur-xl bg-white/95 dark:bg-slate-800/95 rounded-xl border border-white/20 dark:border-slate-700/50 shadow-2xl overflow-hidden">
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-4 gap-1.5">
              ...
              <div className="space-y-1">
                <span className="text-[10px] text-slate-700 dark:text-slate-300 block text-center whitespace-nowrap">
                  Work Duration
                </span>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setLocalSettings((prev) => ({
                        ...
                        fatigueDetection: {
                          ...prev.fatigueDetection,
                          sensitivityLevel: e.target.value as
                            | "low"
                            | "medium"
                            | "high",
                        },
                ...
                <div className="space-y-0.5">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[10px] text-slate-500">
                      {localSettings.fatigueDetection.drowsyThreshold}s
                    </span>
                  </div>
                  <input
                    type="range"
        ...
        <div className="flex gap-1.5 p-2 border-t border-slate-200/50 dark:border-slate-700/50 bg-slate-50/50 dark:bg-slate-900/50">
          ...
          <Button
            onClick={handleSave}
            size="sm"
            className="flex-1 text-[10px] h-6 bg-blue-600 hover:bg-blue-700"
          >
            Save
          </Button>
        </div>
